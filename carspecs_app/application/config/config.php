...
|
*/
$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME']."/carspecs_app";
...
|
*/
$config['index_page'] = 'BuscadorController/display';
...
|
*/
$config['encryption_key'] = 'aldkgvjdbg5wr4sh6ue5rdtjkmf,lg53h5sdg3f5a4fs';
...
$config['sess_expiration'] = 7200; //implica reinicio wamp
